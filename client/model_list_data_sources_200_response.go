...
// checks if the ListDataSources200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDataSources200Response{}
...
type _ListDataSources200Response ListDataSources200Response
...
func NewListDataSources200Response(items []DataSourceDto) *ListDataSources200Response {
	this := ListDataSources200Response{}
	this.Items = items
	return &this
}
...
func (o *ListDataSources200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varListDataSources200Response := _ListDataSources200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListDataSources200Response)

	if err != nil {
		return err
	}

	*o = ListDataSources200Response(varListDataSources200Response)

	return err
}

type NullableListDataSources200Response struct {
	value *ListDataSources200Response
	isSet bool
}

func (v NullableListDataSources200Response) Get() *ListDataSources200Response {
	return v.value
}

func (v *NullableListDataSources200Response) Set(val *ListDataSources200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListDataSources200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListDataSources200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDataSources200Response(val *ListDataSources200Response) *NullableListDataSources200Response {
	return &NullableListDataSources200Response{value: val, isSet: true}
}
