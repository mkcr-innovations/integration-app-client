...
// GetParametersSchema returns the ParametersSchema field value
...
// GetParametersSchemaOk returns a tuple with the ParametersSchema field value
// and a boolean to check if the value has been set.
...
// SetParametersSchema sets field value
